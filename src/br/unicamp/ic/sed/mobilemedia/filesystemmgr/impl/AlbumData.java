...
class AlbumData implements IAlbumData {
	...
	/* (non-Javadoc)
	 * @see br.unicamp.ic.sed.mobilemedia.filesystemmgr.impl.IAlbumData#getImageInfo(java.lang.String)
	 */
	public IImageData getImageInfo( String imageName ) throws ImageNotFoundException{
		return this.imageAccessor.getImageInfo( imageName );
	}

	/* (non-Javadoc) 
	 * @see br.unicamp.ic.sed.mobilemedia.filesystemmgr.impl.IAlbumData#updateImageInfo(br.unicamp.ic.sed.mobilemedia.main.spec.dt.IImageData, br.unicamp.ic.sed.mobilemedia.main.spec.dt.IImageData)
	 */
	public boolean updateImageInfo(IImageData oldData, IImageData newData) throws InvalidImageDataException, PersistenceMechanismException {
		return this.imageAccessor.updateImageInfo(oldData, newData);
	}
