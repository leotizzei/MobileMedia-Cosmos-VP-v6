...
public class PhotoListScreen extends List {
	...
	public Command viewCommand = new Command("View", Command.ITEM, 1);
	public Command addCommand = new Command("Add", Command.ITEM, 1);
	public Command deleteCommand = new Command("Delete", Command.ITEM, 1);
	public Command backCommand = new Command("Back", Command.BACK, 0);

	//[cosmos][add Sce 2. Edit Label]
	public Command editLabelCommand = new Command("Edit Label" , Command.ITEM , 1);
