...
abstract class AbstractController implements CommandListener, ControllerInterface {
	...
	public AbstractController(MIDlet midlet) {
		...
		// [EF] Scenario 04: A singleton ScreenSingleton was created in order to all other access it. 
	...
	protected String getCurrentStoreName() {
		String currentStoreName = ScreenSingleton.getInstance().getCurrentStoreName();
		System.out.println("[AbstractController:getCurrentStoreName()]="+currentStoreName);
